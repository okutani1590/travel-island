...
<main>
    ...
    <section class="p-hero fv">
        <div class="p-hero__inner">
            <picture>
                <source media="(max-width: 768px)" srcset="<?php echo esc_url( $dir ); ?>/assets/img/top/fv-img-sp.png"
                    type="image/png">
            ...
            <ul class="trouble__list">
                <li class="trouble__item js-trouble-item">
                    ...
                    <div class="trouble__list-image">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/trouble-icon01.svg" width="63"
                            height="105" alt="" class="js-trouble-icon" />
                    </div>
                </li>
                <li class="trouble__item js-trouble-item">
                    <div class="trouble__text">
                    ...
                    <div class="trouble__list-image">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/trouble-icon02.svg" width="70"
                            height="105" alt="" class="js-trouble-icon" />
                    </div>
                </li>
                <li class="trouble__item js-trouble-item">
                    ...
                    <div class="trouble__list-image">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/trouble-icon03.svg" width="72"
                            height="102" alt="" class="js-trouble-icon" />
                    </div>
                </li>
                <li class="trouble__item js-trouble-item">
                    <div class="trouble__text">
                    ...
                    <div class="trouble__list-image">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/trouble-icon04.svg" width="88"
                            height="108" alt="" class="js-trouble-icon" />
                    </div>
                </li>
            </ul>
        </div>
    ...
    <section class="sec features" id="features">
        <div class="l-inner">
            <div class="c-sec-header">
                <p class="c-sec-header__subtitle js-fade-up">
                    <i><img src="<?php echo esc_url( $dir ); ?>/assets/img/common/menu-icon03.svg"
                            alt="" /></i>安心できる理由をご紹介
                </p>
            ...
            <ul class="features__list">
                <li class="features__item js-feat-item">
                    ...
                    <div class="features__image-wrapper js-feat-img-wrap">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/features-img01.jpg"
                            alt="スタッフが電話対応している様子" class="features__image js-feat-img" />
                    </div>
                </li>
                <li class="features__item js-feat-item">
                    <div class="features__content js-feat-content">
                        <span class="features__badge">POINT 02</span>
                        <h3 class="features__title">緊急時に備えた医療連携や<br class="sp" />現地サポート</h3>
                        <p class="features__text">事前に現地の医療チームと連携するため、万が一の場合<br class="pc" />でもすぐに対応が可能です。</p>
                    </div>
                    <div class="features__image-wrapper js-feat-img-wrap">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/features-img02.jpg"
                            alt="スタッフが電話対応している様子" class="features__image js-feat-img" />
                    </div>
                </li>
                <li class="features__item js-feat-item">
                    <div class="features__content js-feat-content">
                        ...
                        <p class="features__text">急な病状の変化や移動方法、食事の対応などお客様の<br class="pc" />状況や状態に応じた最適のプランをご提案いたします。</p>
                    </div>
                    <div class="features__image-wrapper js-feat-img-wrap">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/features-img03.jpg"
                            alt="スタッフが電話対応している様子" class="features__image js-feat-img" />
                    </div>
                </li>
                <li class="features__item js-feat-item">
                    <div class="features__content js-feat-content">
                        ...
                        <p class="features__text">全身麻痺や車椅子のご利用など、さまざまな身体状況を<br class="pc" />お持ちのお客様のご提案実績がございます。</p>
                    </div>
                    <div class="features__image-wrapper js-feat-img-wrap">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/features-img04.jpg"
                            alt="スタッフが電話対応している様子" class="features__image js-feat-img" />
                    </div>
                </li>
            </ul>
                ...
                <div class="message-visual js-msg-visual">
                    <picture>
                        <source media="(max-width: 768px)"
                            srcset="<?php echo esc_url( $dir ); ?>/assets/img/top/message-img-sp.png" type="image/png">
                        <img src="<?php echo esc_url( $dir ); ?>/assets/img/top/message-img.jpg"
                            alt="山口 好範（JTB総合提携店トラベル愛ランド）" />
                    </picture>
                </div>
                <div class="message-content">
                    <h2 class="message-title js-msg-item">あなたの大切な旅を、<br class="sp" />安心とともに。</h2>
                    <div class="message-body js-msg-item">
                        <p>地元の旅行会社で多くのお客様と接する中で、旅とは単に目的地に行くことではなく、一人ひとりの人生に寄り添う体験そのものだと深く感じてきました。<br />その思いを胸に、地元・石川を中心に歩んできたトラベル愛ランドは、創業以来ずっと「お客様中心主義」を大切にしてまいりました。<br />旅のご相談や手配はもちろん、不安に思うこと・困っていることにも、じっくりと耳を傾け、安心して出発いただけるようなサポートを心がけています。<br />私たちは、きめ細やかな対応と、地域の方々との深いつながりを強みとして、これからも皆さまの思い描く旅を形にしていきたいと思っています。<br />どうぞお気軽にご相談ください。
                        </p>
                    </div>
    ...
    <section class="sec consultation" id="consultation">
        <div class="l-inner">
            <div class="consultation__desc">
                <h3>お身体の状態・介助内容にあわせて、<br class="" />行き先や過ごし方を柔軟に調整できます。</h3>
                <p>ご希望を伺いながら、専門のスタッフがご提案します。<br class="" />まずはお気軽にご相談ください。</p>
            </div>
            <div class="consultation__img">
                <picture>
                    <source media="(max-width: 768px)"
                        srcset="<?php echo esc_url( $dir ); ?>/assets/img/top/consultation-icon-sp.svg"
                        type="image/png">
                        ...
                        <table class="p-price-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-price-table__ours">70,000円<span
                                            class="p-price-table__note">ドライバー料金込みで別途不要</span></td>
                                    <td class="p-price-table__theirs">80,000円</td>
                                </tr>
                                <tr>
                                    <th class="p-price-table__label" scope="row">移動時間料金</th>
                                    <td class="p-price-table__ours">8,750円<span
                                            class="p-price-table__note">1時間あたり（目安）</span></td>
                                    <td class="p-price-table__theirs">5,500円</td>
                                </tr>
                                <tr>
                                    <th class="p-price-table__label" scope="row">事前面接・事前準備</th>
                                    <td class="p-price-table__ours">0円<span class="p-price-table__note">自社無料！</span>
                                    </td>
                                    <td class="p-price-table__theirs">5,000円</td>
                                </tr>
                                <tr>
                                    <th class="p-price-table__label" scope="row">旅行プランの企画・作成料金</th>
                                    <td class="p-price-table__ours">26,000円<span
                                            class="p-price-table__note">合計20%（トラベル愛ランド上限55,000円）</span></td>
                                    <td class="p-price-table__theirs">30,500円</td>
                                </tr>
                                <tr>
                                    <th class="p-price-table__label" scope="row">その他実費（高速・駐車・飲食・保険）など</th>
                                    <td class="p-price-table__ours">約12,000円<span
                                            class="p-price-table__note">実費同等</span></td>
                                    <td class="p-price-table__theirs">約12,000円</td>
                                </tr>
                                <tr class="p-price-table__row--total">
                                    <th class="p-price-table__label" scope="row">合計</th>
                                    <td class="p-price-table__ours">約156,900円<span
                                            class="p-price-table__note">車両・準備込みの強み</span></td>
                    ...
                    <div class="p-price-table-wrap">
                        <table class="p-price-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="p-price-table__label" scope="row">車両代（車いす専用・ドライバー込み）</th>
                                    <td class="p-price-table__ours">120,000円<span
                                            class="p-price-table__note">ドライバー料金込みで別途不要</span></td>
                                ...
                                <tr>
                                    <th class="p-price-table__label" scope="row">旅行プランの企画・作成料金</th>
                                    <td class="p-price-table__ours">55,000円<span
                                            class="p-price-table__note">合計20%（トラベル愛ランド上限55,000円）</span></td>
                                    <td class="p-price-table__theirs">73,900円</td>
                                </tr>
                                <tr>
                                    <th class="p-price-table__label" scope="row">その他実費（高速・駐車・飲食・保険）など</th>
                                    <td class="p-price-table__ours">約59,000円<span
                                            class="p-price-table__note">実費同等</span></td>
                                    <td class="p-price-table__theirs">約59,000円</td>
                                </tr>
                                <tr class="p-price-table__row--total">
                                    <th class="p-price-table__label" scope="row">合計</th>
                                    <td class="p-price-table__ours">約333,300円<span
                                            class="p-price-table__note">車両・準備込みの強み</span></td>
    ...
    <section class="sec customer-voice" id="customer-voice">
        <div class="l-inner">
            ...
            <div class="swiper js-card-swiper">
                        ...
                        <a href="<?php the_permalink(); ?>" class="c-card">
                            ...
                            <div class="c-card__body">
                                <div class="c-card__meta">
                                    <span
                                        class="c-card__name"><?php echo esc_html( ( get_field( 'names' ) ?: 'S' ) . '様' ); ?></span>
                                    <?php if ( ! empty( $tags ) ) : ?>
        ...
        ?>
            ...
            <div class="btn js-btn btn--position-right">
                <a href="<?php echo esc_url( get_post_type_archive_link( 'voice' ) ); ?>"
                    class="c-button c-button--reverse">
                    <span class="c-button__text">もっと見る</span>
                </a>
            </div>
        </div>
                            ...
                            <div class="c-card__body">
                                <div class="c-article__meta">
                                    ...
                                    <ul class="c-article__categorylist">
                                        <?php if ( ! empty( $cats ) ) : ?>
                                        <li
                                            class="c-article__category c-article__category--<?php echo esc_attr( $cats[0]->slug ); ?>">
                                            <?php echo esc_html( $cats[0]->name ); ?></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                <h3 class="c-card__title"><?php the_title(); ?></h3>
        ...
        <div class="l-inner">
                ...
                <div class="l-inner--left">
                    <div class="c-sec-header c-sec-header--left">
                        <h2 class="c-sec-header__title c-sec-header__title--flex js-fade-up">
                            <i><img src="<?php echo esc_url( $dir ); ?>/assets/img/common/info-icon.svg"
                                    alt="" /></i>お知らせ
                        </h2>
                    </div>
            ...
            ?>
                        <li class="p-news-list__item">
                            <a href="<?php the_permalink(); ?>">
                                ...
                                <h3 class="p-news-list__title"><?php the_title(); ?></h3>
                            </a>
                        </li>
                        <?php
                endwhile;
            ...
            ?>
                ...
                <div class="l-inner--right">
                    <div class="c-sec-header c-sec-header--left">
                        <h2 class="c-sec-header__title c-sec-header__title--flex js-fade-up">
                            <i><img src="<?php echo esc_url( $dir ); ?>/assets/img/common/insta-icon.svg"
                                    alt="" /></i>Instagram
                        </h2>
                    </div>
